...
recipient = 'admin@trln.org'
smtp_user = os.environ['SMTP_USER']
smtp_password = os.environ['SMTP_PASSWORD']
host = "email-smtp.us-east-1.amazonaws.com"
port = 587
report_location = tableau_report.f
...
def build_email(path):
    ...
    subject = "Tableau Report: {}".format(d)

    # The email body for recipients with non-HTML email clients.
    body_text = """TRLN Direct Tableau Report\r\n """
    body_text += "Please see the attached CSV file for tableau report.  "
    body_text += """This report is also available at 
    ...
    <head></head>
    <body>
      <h1>TRLN Direct Tableau Report</h1>"""
    body_html += "Please see the attached CSV file for tableau report.  "
    body_html += """This report is also available 
